...
7. **Captions: 1–4 words, heavy sans, white with a dark shadow, one key word in an accent colour, centred at about 70–74% of the height.** That's the band Veritasium, lingualin and StarTalk use, above the bottom 20% YouTube covers. Cleo's 1.8%-height captions are too small for our muted viewers; we go for about 3.5% like Veritasium. Colour marks meaning (Cleo's lime concept labels, speaker colours in Veritasium and StarTalk), not decoration.
